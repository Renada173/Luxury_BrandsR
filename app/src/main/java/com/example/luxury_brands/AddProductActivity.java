...
public class AddProductActivity extends AppCompatActivity {
    ...
    private String refAfterSuccessfullUpload ="Done Successfully";
    ...
    private void connectComponents() {
        ...
        spCat = findViewById(R.id.spContractorCatAddRest);
        ivPhoto = findViewById(R.id.ivPhotoAddRest);
        fbs = FirebaseServices.getInstance();
        spCat.setAdapter(new ArrayAdapter<sogProduct>(this, android.R.layout.simple_list_item_1, sogProduct.values()));
    ...
    public void add(View view) {
        ...
        Product rest = new Product(name, description, address, phone, sogProduct.valueOf(category), photo);
